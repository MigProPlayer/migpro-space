...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Continuar Jogo") action ShowMenu("load")

        else:

            textbutton _("Guardar Jogo") action ShowMenu("save")
        ...
        if _in_replay:
            ...
            textbutton _("Acabar Replay") action EndReplay(confirm=True)
        ...
        if main_menu:
            ...
            if renpy.variant("pc") or (renpy.variant("android") and not renpy.variant("ios")):
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Página {}"), auto=_("Saves Automáticas"))
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%H:%M | %d/%m/%Y"), empty=_("")):
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        ...
                        textbutton _("Ecrã Inteiro") action Preference("display", "fullscreen")
...
screen history():
    ...
    use game_menu(_("Histórico"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
        ...
        if not _history_list:
            label _("O histórico está vazio.")
    ...
    use game_menu(_("Ajuda"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Rato") action SetScreenVariable("device", "mouse")
